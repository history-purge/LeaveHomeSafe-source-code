...
public final class i {
  ...
  public static ActionMode.Callback a(TextView paramTextView, ActionMode.Callback paramCallback) {
    ...
    return (j >= 26 && j <= 27) ? ((paramCallback instanceof a) ? paramCallback : new a(paramCallback, paramTextView)) : paramCallback;
  }
  ...
  public static void a(TextView paramTextView, c paramc) {
    ...
    if (Build.VERSION.SDK_INT >= 29) {
      precomputedText = paramc.b();
    } else if (!e(paramTextView).a(precomputedText.a())) {
      illegalArgumentException = new IllegalArgumentException("Given text can not be applied to TextView.");
      throw illegalArgumentException;
    } 
    illegalArgumentException.setText((CharSequence)precomputedText);
  }
  ...
  public static c.a e(TextView paramTextView) {
    if (Build.VERSION.SDK_INT >= 28)
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/androidx/core/widget/i.class
