...
public final class c {
  ...
  public static ColorStateList b(CompoundButton paramCompoundButton) {
    return (Build.VERSION.SDK_INT >= 21) ? paramCompoundButton.getButtonTintList() : ((paramCompoundButton instanceof j) ? ((j)paramCompoundButton).getSupportButtonTintList() : null);
  }
}


/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/androidx/core/widget/c.class
