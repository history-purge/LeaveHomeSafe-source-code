...
public class m {
  ...
  static h a(Object paramObject) {
    ...
    if (bool1 && bool2)
      return new FullLifecycleObserverAdapter((c)paramObject, (h)paramObject); 
    if (bool2)
    ...
    if (b(clazz) == 2) {
      ...
      while (i < list.size()) {
        arrayOfD[i] = a(list.get(i), paramObject);
        i++;
      } 
  ...
  private static int d(Class<?> paramClass) {
    ...
    if (paramClass.getCanonicalName() == null)
      return 1; 
    Constructor<? extends d> constructor = a(paramClass);
    if (constructor != null) {
    ...
    for (Class<?> clazz1 : paramClass.getInterfaces()) {
      if (c(clazz1)) {
        if (b(clazz1) == 1)
          return 1; 
        ArrayList<Constructor<? extends d>> arrayList1 = arrayList;
        if (arrayList == null)
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/androidx/lifecycle/m.class
