...
public final class a<T> {
  private final d<ArrayList<T>> a = (d<ArrayList<T>>)new Pools.SimplePool(10);
  ...
  public void a() {
    int j = this.b.size();
    for (int i = 0; i < j; i++) {
      ArrayList<T> arrayList = (ArrayList)this.b.d(i);
      if (arrayList != null)
        a(arrayList); 
    } 
    this.b.clear();
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/androidx/coordinatorlayout/widget/a.class
