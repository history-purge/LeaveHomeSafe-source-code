...
public class j {
  ...
  public static void a(double[] paramArrayOfdouble, double paramDouble) {
  ...
  public static void a(double[] paramArrayOfdouble, a parama) {
    boolean bool;
    ...
    e.e.m.a.a.a(bool);
    double[] arrayOfDouble5 = parama.a;
    double[] arrayOfDouble3 = parama.b;
    double[] arrayOfDouble4 = parama.c;
    double[] arrayOfDouble6 = parama.d;
    double[] arrayOfDouble2 = parama.e;
    if (b(paramArrayOfdouble[15]))
      return; 
    ...
    for (i = 0; i < 4; i++) {
      ...
      for (k = 0; k < 4; k++) {
        int m = i * 4 + k;
        double d = paramArrayOfdouble[m] / paramArrayOfdouble[15];
        arrayOfDouble7[i][k] = d;
        if (k == 3)
          d = 0.0D; 
        arrayOfDouble8[m] = d;
      } 
    ...
    if (b(a(arrayOfDouble8)))
      return; 
    if (!b(arrayOfDouble7[0][3]) || !b(arrayOfDouble7[1][3]) || !b(arrayOfDouble7[2][3])) {
      double d1 = arrayOfDouble7[0][3];
      double d2 = arrayOfDouble7[1][3];
      double d3 = arrayOfDouble7[2][3];
      double d4 = arrayOfDouble7[3][3];
      paramArrayOfdouble = d(b(arrayOfDouble8));
      b(new double[] { d1, d2, d3, d4 }, paramArrayOfdouble, arrayOfDouble5);
    } else {
    ...
    arrayOfDouble3[0] = e(arrayOfDouble1[0]);
    arrayOfDouble1[0] = i(arrayOfDouble1[0], arrayOfDouble3[0]);
    arrayOfDouble4[0] = b(arrayOfDouble1[0], arrayOfDouble1[1]);
    arrayOfDouble1[1] = a(arrayOfDouble1[1], arrayOfDouble1[0], 1.0D, -arrayOfDouble4[0]);
    arrayOfDouble4[0] = b(arrayOfDouble1[0], arrayOfDouble1[1]);
    arrayOfDouble1[1] = a(arrayOfDouble1[1], arrayOfDouble1[0], 1.0D, -arrayOfDouble4[0]);
    arrayOfDouble3[1] = e(arrayOfDouble1[1]);
    arrayOfDouble1[1] = i(arrayOfDouble1[1], arrayOfDouble3[1]);
    arrayOfDouble4[0] = arrayOfDouble4[0] / arrayOfDouble3[1];
    arrayOfDouble4[1] = b(arrayOfDouble1[0], arrayOfDouble1[2]);
    arrayOfDouble1[2] = a(arrayOfDouble1[2], arrayOfDouble1[0], 1.0D, -arrayOfDouble4[1]);
    arrayOfDouble4[2] = b(arrayOfDouble1[1], arrayOfDouble1[2]);
    arrayOfDouble1[2] = a(arrayOfDouble1[2], arrayOfDouble1[1], 1.0D, -arrayOfDouble4[2]);
    arrayOfDouble3[2] = e(arrayOfDouble1[2]);
    arrayOfDouble1[2] = i(arrayOfDouble1[2], arrayOfDouble3[2]);
    arrayOfDouble4[1] = arrayOfDouble4[1] / arrayOfDouble3[2];
    arrayOfDouble4[2] = arrayOfDouble4[2] / arrayOfDouble3[2];
    arrayOfDouble4 = a(arrayOfDouble1[1], arrayOfDouble1[2]);
    if (b(arrayOfDouble1[0], arrayOfDouble4) < 0.0D)
      for (i = 0; i < 3; i++) {
    ...
    arrayOfDouble2[0] = c(-Math.atan2(arrayOfDouble1[2][1], arrayOfDouble1[2][2]) * 57.29577951308232D);
    arrayOfDouble2[1] = c(-Math.atan2(-arrayOfDouble1[2][0], Math.sqrt(arrayOfDouble1[2][1] * arrayOfDouble1[2][1] + arrayOfDouble1[2][2] * arrayOfDouble1[2][2])) * 57.29577951308232D);
    arrayOfDouble2[2] = c(-Math.atan2(arrayOfDouble1[1][0], arrayOfDouble1[0][0]) * 57.29577951308232D);
  }
  ...
  private static boolean b(double paramDouble) {
    boolean bool1 = Double.isNaN(paramDouble);
    boolean bool = false;
    if (bool1)
      return false; 
    if (Math.abs(paramDouble) < 1.0E-5D)
      bool = true; 
    return bool;
  }
  ...
  public static double e(double[] paramArrayOfdouble) {
  ...
  public static double[] i(double[] paramArrayOfdouble, double paramDouble) {
    double d = paramDouble;
    if (b(paramDouble))
      d = e(paramArrayOfdouble); 
    paramDouble = 1.0D / d;
  ...
  public static class a {
    ...
    private static void a(double[] param1ArrayOfdouble) {
      for (int i = 0; i < param1ArrayOfdouble.length; i++)
        param1ArrayOfdouble[i] = 0.0D; 
    }
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/com/facebook/react/uimanager/j.class
