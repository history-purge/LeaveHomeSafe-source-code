...
public class g implements Interpolator {
  ...
  public g(Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser) {
    TypedArray typedArray = b.g.e.d.g.a(paramResources, paramTheme, paramAttributeSet, a.l);
  ...
  private void a(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser) {
    ...
    if (b.g.e.d.g.a(paramXmlPullParser, "pathData")) {
      str = b.g.e.d.g.a(paramTypedArray, paramXmlPullParser, "pathData", 4);
      Path path = c.b(str);
      if (path != null) {
        a(path);
        return;
    ...
    if (b.g.e.d.g.a((XmlPullParser)stringBuilder, "controlX1")) {
      if (b.g.e.d.g.a((XmlPullParser)stringBuilder, "controlY1")) {
        float f1 = b.g.e.d.g.a((TypedArray)str, (XmlPullParser)stringBuilder, "controlX1", 0, 0.0F);
        float f2 = b.g.e.d.g.a((TypedArray)str, (XmlPullParser)stringBuilder, "controlY1", 1, 0.0F);
        boolean bool = b.g.e.d.g.a((XmlPullParser)stringBuilder, "controlX2");
        if (bool == b.g.e.d.g.a((XmlPullParser)stringBuilder, "controlY2")) {
          if (!bool) {
            a(f1, f2);
            return;
          } 
          a(f1, f2, b.g.e.d.g.a((TypedArray)str, (XmlPullParser)stringBuilder, "controlX2", 2, 0.0F), b.g.e.d.g.a((TypedArray)str, (XmlPullParser)stringBuilder, "controlY2", 3, 0.0F));
          return;
        } 
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/b/s/a/a/g.class
