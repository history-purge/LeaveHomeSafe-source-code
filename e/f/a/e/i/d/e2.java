...
public final class e2<K, V> extends LinkedHashMap<K, V> {
  ...
  public final void a(e2<K, V> parame2) {
    f();
    if (!parame2.isEmpty())
      putAll(parame2); 
  }
  ...
  public final e2<K, V> b() {
    return isEmpty() ? new e2() : new e2(this);
  }
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/e/f/a/e/i/d/e2.class
