...
final class g4 extends d4 {
  private static int a(byte[] paramArrayOfbyte, int paramInt1, long paramLong, int paramInt2) {
    if (paramInt2 != 0) {
      if (paramInt2 != 1) {
        if (paramInt2 == 2)
          return c4.b(paramInt1, a4.a(paramArrayOfbyte, paramLong), a4.a(paramArrayOfbyte, paramLong + 1L)); 
        throw new AssertionError();
      } 
      return c4.b(paramInt1, a4.a(paramArrayOfbyte, paramLong));
    } 
    return c4.b(paramInt1);
  }
    ...
    if (i <= paramInt2 && paramArrayOfbyte.length - paramInt2 >= paramInt1) {
      ...
      while (true) {
        ...
        if (paramInt2 < i) {
          ...
          if (paramInt1 < 128) {
            a4.a(paramArrayOfbyte, l1, (byte)paramInt1);
            paramInt2++;
            l1 = 1L + l1;
            continue;
          } 
      ...
      while (paramInt1 < i) {
        ...
        if (c1 < '' && l4 < l2) {
          a4.a(paramArrayOfbyte, l4, (byte)c1);
          long l = l3;
          l1 = l4 + l3;
          l3 = l;
        } else if (c1 < 'ࠀ' && l4 <= l2 - 2L) {
          l1 = l4 + l3;
          a4.a(paramArrayOfbyte, l4, (byte)(c1 >>> 6 | 0x3C0));
          a4.a(paramArrayOfbyte, l1, (byte)(c1 & 0x3F | 0x80));
          l1 += l3;
        } else if ((c1 < '?' || '?' < c1) && l4 <= l2 - 3L) {
          l1 = l4 + l3;
          a4.a(paramArrayOfbyte, l4, (byte)(c1 >>> 12 | 0x1E0));
          l3 = l1 + l3;
          a4.a(paramArrayOfbyte, l1, (byte)(c1 >>> 6 & 0x3F | 0x80));
          a4.a(paramArrayOfbyte, l3, (byte)(c1 & 0x3F | 0x80));
          l1 = l3 + 1L;
          l3 = 1L;
        } else if (l4 <= l2 - 4L) {
          ...
          if (paramInt2 != i) {
            ...
            if (Character.isSurrogatePair(c1, c2)) {
              ...
              l3 = l4 + 1L;
              a4.a(paramArrayOfbyte, l4, (byte)(paramInt1 >>> 18 | 0xF0));
              l1 = l3 + 1L;
              a4.a(paramArrayOfbyte, l3, (byte)(paramInt1 >>> 12 & 0x3F | 0x80));
              l4 = l1 + 1L;
              a4.a(paramArrayOfbyte, l1, (byte)(paramInt1 >>> 6 & 0x3F | 0x80));
              l3 = 1L;
              l1 = l4 + 1L;
              a4.a(paramArrayOfbyte, l4, (byte)(paramInt1 & 0x3F | 0x80));
              paramInt1 = paramInt2;
            } else {
              paramInt1 = paramInt2;
              throw new f4(paramInt1 - 1, i);
            } 
          } else {
            throw new f4(paramInt1 - 1, i);
          } 
      ...
      if (m == j) {
        ...
        while (k < j) {
          ...
          if (c1 < '' && l5 < l3) {
            ...
            l1 = l5 + 1L;
            a4.a(l5, (byte)(c1 >>> 6 | 0x3C0));
            a4.a(l1, (byte)(c1 & 0x3F | 0x80));
            l1++;
          } else if ((c1 < '?' || '?' < c1) && l5 <= l3 - 3L) {
            l1 = l5 + 1L;
            a4.a(l5, (byte)(c1 >>> 12 | 0x1E0));
            l5 = l1 + 1L;
            a4.a(l1, (byte)(c1 >>> 6 & 0x3F | 0x80));
            a4.a(l5, (byte)(c1 & 0x3F | 0x80));
            l1 = l5 + 1L;
          } else if (l5 <= l3 - 4L) {
            m = k + 1;
            if (m != j) {
              ...
              if (Character.isSurrogatePair(c1, c2)) {
                ...
                l1 = l5 + 1L;
                a4.a(l5, (byte)(k >>> 18 | 0xF0));
                l5 = l1 + 1L;
                a4.a(l1, (byte)(k >>> 12 & 0x3F | 0x80));
                l1 = l5 + 1L;
                a4.a(l5, (byte)(k >>> 6 & 0x3F | 0x80));
                a4.a(l1, (byte)(k & 0x3F | 0x80));
                l1++;
                k = m;
              } else {
                throw new f4(k - 1, j);
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/e/f/a/e/i/d/g4.class
