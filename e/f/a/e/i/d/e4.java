      ...
      if (b < 0) {
        ...
        if (b < -16) {
          if (paramInt2 >= paramInt3 - 1)
            return c4.c(paramArrayOfbyte, paramInt2, paramInt3); 
          int i = paramInt2 + 1;
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/e/f/a/e/i/d/e4.class
