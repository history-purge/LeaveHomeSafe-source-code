...
final class o {
  private final ConcurrentHashMap<n, List<Throwable>> a = new ConcurrentHashMap<n, List<Throwable>>(16, 0.75F, 10);
  ...
  public final List<Throwable> a(Throwable paramThrowable, boolean paramBoolean) {
    while (true) {
      ...
      reference = new n(paramThrowable, null);
      List<Throwable> list2 = this.a.get(reference);
      if (list2 != null)
        return list2; 
      list2 = new Vector<Throwable>(2);
      List<Throwable> list1 = this.a.putIfAbsent(new n(paramThrowable, this.b), list2);
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/e/f/a/e/i/i/o.class
