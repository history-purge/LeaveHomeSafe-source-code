  ...
  static {
    ...
    b = new int[][] { 
        arrayOfInt1, arrayOfInt2, { 
          ...
          185, 184, 191, 190, 197, 196, 203, 202, 818, 817 }, arrayOfInt3, { 
          285, 284, 279, 278, 273, 272, 267, 266, 261, 260, 
          255, 254, 249, 248, 243, 242, 237, 236, 231, 230, 
          225, 224, 219, 218, 213, 212, 207, 206, 821, 820 }, arrayOfInt4, arrayOfInt5, { 
          291, 290, 297, 296, 303, 302, 309, 308, 315, 314, 
          321, 320, 327, 326, 333, 332, 339, 338, 345, 344, 
          351, 350, 357, 356, 363, 362, 369, 368, 825, -3 }, arrayOfInt6, arrayOfInt7, 
        arrayOfInt8, { 
          ...
          85, 84, 433, 432, 439, 438, 445, 444, 833, 832 }, arrayOfInt9, { 
          419, 418, 425, 424, 431, 430, 107, 106, 59, 58, 
          -3, -3, -3, -3, -3, -3, -3, -3, -3, 23, 
          89, 88, 437, 436, 443, 442, 449, 448, 836, 835 }, arrayOfInt10, arrayOfInt11, arrayOfInt12, arrayOfInt13, arrayOfInt14, 
        { 
    ...
    for (int i = 0; i < j; i++) {
      ...
      for (int m = 0; m < k; m++) {
        ...
        if (n >= 0 && this.a.b(m, i)) {
          ...
          arrayOfByte[i1] = (byte)((byte)(1 << 5 - n % 6) | b1);
        } 
      } 
    } 
    return arrayOfByte;
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/e/f/c/u/b/a.class
