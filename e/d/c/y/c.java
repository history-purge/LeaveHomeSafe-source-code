...
public class c {
  ...
  private static HashMap<String, String> e = new HashMap<String, String>();
  
  static {
    a.put(Integer.valueOf(1), b);
    a.put(Integer.valueOf(110), c);
    HashMap<Integer, HashMap<String, String>> hashMap = a;
    Integer integer = Integer.valueOf(101);
    hashMap.put(integer, d);
    a.put(integer, e);
...
/* Location:              /home/yc/Downloads/LeaveHomeSafe.jar!/e/d/c/y/c.class
